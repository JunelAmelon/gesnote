 ...
 <!-- ======= Header ======= -->
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <div class="row">
        <div class="col-xl-6">
          <h1>Espace de creation d'un enseignant !</h1>
          <h2></h2>
    ...
    <section class="breadcrumbs" style="margin-top: 0%; margin-bottom: 0%; background-color:white;">
      <div class="container">
        ...
        <ol>
          ...
          <li style="color: black;">Teacher</li>
        </ol>
    ...
    @endif
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-8 offset-lg-2 ">
            <form action="{{route('SaveTeacher')}}" method="post" role="" class="login-form">
                @csrf
          ...
          <p> Assurez vous que les donnees renseignes sont corrects</p>
              ...
              <div class="form-group">
                <input type="text" name="id_prof" class="form-control" id="id_etu" placeholder="Entrez votre identifiant" required>
               </div>
              <div class="form-group">
               <input type="password" class="form-control" name="password" id="email" placeholder="Entrez votre mot de passe" required>
               </div>
               <div class="form-group">
                <input type="text" name="nom" class="form-control" id="id_etu" placeholder="Entrez un nom" required>
               </div>
              
               <div class="form-group">
                <input type="text" name="prenom" class="form-control" id="id_etu" placeholder="Entrez un prenom" required>
               </div>
              
               <div class="form-group">
                <input type="text" name="sexe" class="form-control" id="id_etu" placeholder="Entrez le sexe: M ou F" required>
               </div>
              
               <div class="form-group">
                <input type="date" name="date_naissance" class="form-control" id="id_etu" placeholder="Entrez la date de naissance" required>
               </div>
              
               <div class="form-group">
                <input type="text" name="lieu_naissance" class="form-control" id="id_etu" placeholder="Entrez le lieu de naissance" required>
               </div>
