 ...
 <!-- ======= Header ======= -->
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <div class="row">
        <div class="col-xl-6">
          <h1>Bienvenue sur votre espace ensignant !</h1>
 ...
 <!-- ======= Breadcrumbs ======= -->
    <section class="breadcrumbs" style="margin-top: 0%; margin-bottom: 0%; background-color:white;">
      <div class="container">
        ...
        <ol>
          <li><a href="/acceuil/prof " style="color: black;">noter</a></li>
          <li style="color: black;">etudiant</li>
        </ol>
    ...
    @endif
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-8 offset-lg-2 ">
            <form action="{{route('noter')}}" method="post" role="" class="login-form">
                @csrf
          ...
          <p> Assurez vous que les donnees renseignes sont corrects</p>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <input type="text" name="valeur" class="form-control" id="id_etu" placeholder="Entrez la note" required>
               </div>
              <label>Choisissez la note :</label>
        <input type="radio" id="note1" name="choix_note" value="note1">
        <label for="note1">note 1</label>

        <input type="radio" id="note2" name="choix_note" value="note2">
        <label for="note2">note 2</label>

        <input type="radio" id="note3" name="choix_note" value="note3">
        <label for="note3">note 3</label>

              

           <div class="text-left"> <button  type="submit">Noter</button></div>
            </form>
          </div>
